...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
					...
					<div class="step-content row-fluid position-relative">
						<div style="float: left;">
							<span class="input-icon">
								<input type="text" id="serverUrl" title="输入请求地址" value="${project_name}/appuser/getAppuserByUm.do?USERNAME=dsfsd" style="width:540px;">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		<!-- 引入 -->
		<!--MD5-->
		<script type="text/javascript" src="${css_imagedomain}/js/jQuery.md5.js"></script>
		<!--提示框-->
		<script type="text/javascript" src="${css_imagedomain}/js/jquery.tips.js"></script>
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${css_imagedomain}/js/myjs/interfaceTest.js"></script>
