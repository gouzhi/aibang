...
public class AbUsersOpt extends BaseEntity implements Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof AbUsersOpt == false) return false;
		if(this == obj) return true;
		AbUsersOpt other = (AbUsersOpt)obj;
