...
<div id="zhongxin" style="padding: 15px 0 0 20px;font-size: 16px;">
	<table style="width: 100%">
		...
		<tr style="position: relative;">
			...
			<td><textarea rows="" cols="" style="margin: 0px 0px 10px;width: 400px;height: 100px;resize: none;" name="verifyRemark">${info.verifyRemark}</textarea></td>
		</tr>
		<tr>
