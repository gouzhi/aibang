...
<html lang="en">
	...
	<link rel="stylesheet" href="${css_imagedomain}/plugins/zTree/3.5/zTreeStyle.css" type="text/css">
	<script type="text/javascript" src="${css_imagedomain}/js/jquery-1.5.1.min.js"></script>
	<script type="text/javascript" src="${css_imagedomain}/plugins/zTree/3.5/jquery.ztree.core-3.5.js"></script>
...
<table style="width:100%;" border="0">
	<tr>
		...
		<td style="width:85%;" valign="top" >
			<iframe name="treeFrame" id="treeFrame" frameborder="0" src="${project_name}/happuser/listUsers.do" style="margin:0 auto;width:100%;height:100%;"></iframe>
		</td>
	</tr>
</table>
