...
public class AbApproveSms extends BaseEntity implements Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof AbApproveSms == false) return false;
		if(this == obj) return true;
		AbApproveSms other = (AbApproveSms)obj;
