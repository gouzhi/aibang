package com.aibang.framework.generator.provider.db.table.model;
...
import com.aibang.framework.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.aibang.framework.generator.provider.db.table.model.util.ColumnHelper;
import com.aibang.framework.generator.util.GLogger;
import com.aibang.framework.generator.util.StringHelper;
import com.aibang.framework.generator.util.TestDataGenerator;
import com.aibang.framework.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.aibang.framework.generator.util.typemapping.DatabaseDataTypesUtils;
import com.aibang.framework.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column implements java.io.Serializable,Cloneable{
	...
	public Column(Table table, int sqlType, String sqlTypeName,
		...
		fieldNull=isNullable?"true":"false";
