...
<html lang="en">
	...
	<!--引入属于此页面的js -->
	<script type="text/javascript" src="${css_imagedomain}/js/myjs/readTwoD.js"></script>
	</head> 
<body>
						...
						<div style="width:715px;padding-left: 20px;">
							<div style="width:285px;float: left;">
								<div class="widget-box">
									...
									<div class="widget-body">
									 <div class="widget-main">
										<img id="encoderImgId" cache="false" src="${project_name}/${css_imagedomain}/img/default.png" width="265px" height="265px;"/>
									 </div><!--/widget-main-->
									</div><!--/widget-body-->
								</div><!--/widget-box-->
							 </div><!--/span-->	
