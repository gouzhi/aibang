...
public class HjsUsersInvite extends BaseEntity implements Serializable{
	 ...
	 * 邀请人账户信息
	 */
	private HjsUserBase inviteBase;

	public HjsUserBase getInviteBase() {
		return inviteBase;
	}

	public void setInviteBase(HjsUserBase inviteBase) {
		this.inviteBase = inviteBase;
	}

	public HjsUsersInvite(){
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof HjsUsersInvite == false) return false;
		if(this == obj) return true;
		HjsUsersInvite other = (HjsUsersInvite)obj;
