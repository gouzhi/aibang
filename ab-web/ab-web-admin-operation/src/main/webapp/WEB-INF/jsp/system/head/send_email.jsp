...
<body>
		...
		<table style="width:98%;" >
			<tr>
				<td style="margin-top:0px;">
					 ...
					 <div style="float: right;" style="width:19%"><a class='btn btn-mini btn-info' title="编辑邮箱" onclick="dialog_open();">编辑</a></div>
				</td>
			</tr>
			<tr>
				<td>
		...
		<div id="zhongxin2" class="center" style="display:none"><br/><img src="${css_imagedomain}/images/jzx.gif" id='msg' /><br/><h4 class="lighter block green" id='msg'>正在发送...</h4></div>
		...
		<!-- 编辑框-->
		<script type="text/javascript" charset="utf-8">window.UEDITOR_HOME_URL = "<%=path%>/${css_imagedomain}/plugins/ueditor/";</script>
		<script type="text/javascript" charset="utf-8" src="${css_imagedomain}/plugins/ueditor/ueditor.config.js"></script>
		<script type="text/javascript" charset="utf-8" src="${css_imagedomain}/plugins/ueditor/ueditor.all.js"></script>
		<!-- 编辑框-->
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${css_imagedomain}/js/myjs/headEmail.js"></script>
