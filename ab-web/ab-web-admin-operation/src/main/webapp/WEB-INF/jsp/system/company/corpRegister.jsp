...
<form action="companyRegister/corpRegister.do" name="userForm" id="userForm" method="post">
	<div class="row-fluid"><input type="hidden" name="id" id="user_id" value=""/>
	    <div class="span12">企业开户</div>
	</div>
    <div class="row-fluid">
         ...
         <div class="span2 pl"><span class="required">*</span>借款用户ID：</div>
         <div class="span4">
         	<input type="text" class="span11" name="UsrId"  placeholder="输入借款用户ID" title="借款用户ID"/>
         </div>
    </div>
    <div class="row-fluid">
