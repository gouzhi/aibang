...
import ${basepackage}.xml.${className};
<#include "/java_imports.include">

public class ${className}BizTest extends BaseManagerTestCase{

	private ${className}Biz manager;
	
	@Autowired
	public void set${className}Manager(${className}Biz manager) {
