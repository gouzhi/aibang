...
<link rel="stylesheet" href="${css_imagedomain}/login/bootstrap.min.css" />
<link rel="stylesheet" href="${css_imagedomain}/login/css/camera.css" />
<link rel="stylesheet" href="${css_imagedomain}/login/bootstrap-responsive.min.css" />
<link rel="stylesheet" href="${css_imagedomain}/login/matrix-login.css" />
<link href="${css_imagedomain}/login/font-awesome.css" rel="stylesheet" />
		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group normal_text">
					<h3>
<!-- 						<img src="${css_imagedomain}/login/logo.png" alt="Logo" /> -->
					</h3>
				</div>
					...
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg"><i><img height="37"
									src="${css_imagedomain}/login/user.png" /></i></span><input type="text"
					...
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_ly"><i><img height="37"
									src="${css_imagedomain}/login/suo.png" /></i></span><input type="password"
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;">
							<i><img src="${css_imagedomain}/login/yan.png" /></i>
						</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © CIFEX 2015</span></font>
				</div>
			</div>
		</div>
	</div>
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			<div data-src="${css_imagedomain}/login/images/banner_slide_01.jpg"></div>
			<div data-src="${css_imagedomain}/login/images/banner_slide_02.jpg"></div>
			<div data-src="${css_imagedomain}/login/images/banner_slide_03.jpg"></div>
		</div>
		<!-- #camera_wrap_3 -->
	</div>
