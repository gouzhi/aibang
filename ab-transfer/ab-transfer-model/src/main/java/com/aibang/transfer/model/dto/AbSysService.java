...
public class AbSysService extends BaseEntity implements java.io.Serializable{
	 ...
	 * 父类服务
	 */
	private AbSysMenu parentService;
	/**
	 * 子服务列表
	 */
	private List<AbSysService> subService;
	/**
	 * 是否有子服务
	 */
	...
	public AbSysMenu getParentService() {
		return parentService;
	}

	public void setParentService(AbSysMenu parentService) {
		this.parentService = parentService;
	}

	public List<AbSysService> getSubService() {
		return subService;
	}

	public void setSubService(List<AbSysService> subService) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof AbSysService == false) return false;
		if(this == obj) return true;
		AbSysService other = (AbSysService)obj;
