...
<body>
				...
				<div class="row-fluid">
					...
					<form  method="post"
						...
						<table id="table_report"
							...
							<c:choose>
								<c:when test="${not empty tenderAccountSumList}">

									<c:forEach items="${tenderAccountSumList}" var="bp"
											   varStatus="vs">
										...
										<tr>
											...
											<td class="center">${bp.tenderAccountSum}</td>
	...
	<script type="text/javascript">
        //检索
		function search() {
			$("#projectForm").attr("action","${project_name}/tenderAccountSum/findTenderAccountSumList.do");
         $("#projectForm").submit();

		}
		function exportExcel(){
			$("#projectForm").attr("action","${project_name}/tenderAccountSum/exportExcel.do");
			$("#projectForm").submit();
		}
     </script>
