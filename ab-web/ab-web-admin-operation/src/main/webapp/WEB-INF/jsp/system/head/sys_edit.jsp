...
<html lang="en">
	<head>
		...
		<!-- 上传图片插件 -->
		<link href="${css_imagedomain}/plugins/uploadify/uploadify.css" rel="stylesheet" type="text/css">
		<script type="text/javascript" src="${css_imagedomain}/plugins/uploadify/swfobject.js"></script>
		<script type="text/javascript" src="${css_imagedomain}/plugins/uploadify/jquery.uploadify.v2.1.4.min.js"></script>
		<!-- 上传图片插件 -->
		<script type="text/javascript">
		var jsessionid = "<%=session.getId()%>";  //勿删，uploadify兼容火狐用到
		</script>
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${css_imagedomain}/js/myjs/sys.js"></script>	
			  ...
			  <div id="profile" class="tab-pane">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td colspan="10">
						<div style="float:left;"><img src="${project_name}/uploadFiles/uploadImgs/${pd.imgUrl}"  width="100"/></div>
			  ...
			  <div id="profile3" class="tab-pane">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td><input type="text" name="WXURL" id="WXURL" value="${project_name}/weixin/index " disabled="disabled"  style="width:90%" title="URL(服务器地址)必须是域名，ip地址验证通不过"/></td>
					</tr>
					<tr>
