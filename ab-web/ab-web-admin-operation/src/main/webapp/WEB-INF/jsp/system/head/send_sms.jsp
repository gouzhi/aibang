...
<html lang="en">
	<head>
		...
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${css_imagedomain}/js/myjs/sms.js"></script>
	</head>
<body>
		<!-- 编辑手机号  -->
		<div id="dialog-add">
		...
		<table style="width:99%;">
			<tr>
				<td style="margin-top:0px;">
					 ...
					 <div style="float: right;"><a class='btn btn-mini btn-info' title="编辑手机号" onclick="dialog_open();">编辑</a></div>
				</td>
			</tr>
			<tr>
				<td id="nr">
