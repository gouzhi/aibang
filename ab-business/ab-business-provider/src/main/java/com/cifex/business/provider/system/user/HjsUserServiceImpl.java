...
@Service("hjsUserService")
@SuppressWarnings({"unchecked"})
public class HjsUserServiceImpl  extends ProviderServiceBase<HjsUser,Integer> implements HjsUserService {
	...
	public HjsUser getSysUserByNameAndPwd(HjsUserQuery query) {
		HjsUser user = null;
		try {
			user = (HjsUser) findForObject("HjsUser.getUserInfo", query);
	...
	public HjsUser getByPhone(String phone) {
		return (HjsUser) findForObject("HjsUser.getByPhone", phone);
	}
}
