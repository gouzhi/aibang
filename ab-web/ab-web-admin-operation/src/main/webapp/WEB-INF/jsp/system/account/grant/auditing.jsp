	...
	<table style="width: 100%">
	   <tr>
			...
			<td style="font-size:15px; ">
				<input type="radio" value="1" name="verifyStatus" checked="checked" style="opacity:1;position: inherit;vertical-align: middle;width: 15px;"/><span style="margin-right: 50px;vertical-align: middle;">放款</span>
			</td>
		</tr>
		<tr style="height: 20px;"></tr>
		<tr >
			<td>备注：</td>
			<td><textarea rows="" cols="" maxlength="200" style="margin: 0px 0px 10px;width: 400px;height: 100px;resize: none;" id="verifyRemark" name="verifyRemark"></textarea></td>
		</tr>
		<tr>
...
function auditingSb(){
		...
		$.ajax({
			url:"${project_name}/grant/auditingSb.do",
			type:"post",
			data:$("#form").serialize(),
			dataType:"json",
			async: false,
