...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
				...
				<table style="width:100%;" id="xtable">
					<tr>
						<td style="margin-top:0px;">
							 ...
							 <div style="float: right;width:10%"><a class='btn btn-mini btn-info' title="编辑邮箱" onclick="dialog_open();">编辑</a></div>
						</td>
					</tr>
					<tr>
						<td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		<!-- 编辑框-->
		<script type="text/javascript" charset="utf-8">window.UEDITOR_HOME_URL = "${css_imagedomain}/plugins/ueditor/";</script>
