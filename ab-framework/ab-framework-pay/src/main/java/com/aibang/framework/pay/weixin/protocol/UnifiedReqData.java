...
public class UnifiedReqData {
     ...
     * 
     */
    public UnifiedReqData(String deviceInfo,String body,String detail,String attach,String outTradeNo, int totalFee, String ip, String timeStart, String timeExpire,
        ...
        //随机字符串，不长于32 位
        setNonce_str(UuidUtil.get32UUID());
