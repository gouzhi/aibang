...
*/
	public static void init(InputStream confInputStream) throws FileNotFoundException, IOException, MyException
	{
  		IniFileReader iniReader;
  		String[] szTrackerServers;
			String[] parts;
			
  		iniReader = new IniFileReader(confInputStream);
  		...
  		{
  			throw new MyException("item \"tracker_server\" in " + confInputStream.getClass().getName() + " not found");
  		}
