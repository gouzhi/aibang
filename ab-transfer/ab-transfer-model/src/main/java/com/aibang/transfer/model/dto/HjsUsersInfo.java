...
public class HjsUsersInfo extends BaseEntity implements Serializable{
	 ...
	 * 会员区域信息
	 */
	private HjsSysArea hjsSysArea;
	/**
	 * 会员黑名单信息
	 */
	private HjsUsersBlack hjsUsersBlack;
	
	private HjsUsersInvite hjsUsersInvite;
	...
	public HjsSysArea getHjsSysArea() {
		return hjsSysArea;
	}

	public void setHjsSysArea(HjsSysArea hjsSysArea) {
		this.hjsSysArea = hjsSysArea;
	}

	public HjsUsersBlack getHjsUsersBlack() {
		return hjsUsersBlack;
	}

	public void setHjsUsersBlack(HjsUsersBlack hjsUsersBlack) {
		this.hjsUsersBlack = hjsUsersBlack;
	}

	public HjsUsersInvite getHjsUsersInvite() {
		return hjsUsersInvite;
	}

	public void setHjsUsersInvite(HjsUsersInvite hjsUsersInvite) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof HjsUsersInfo == false) return false;
		if(this == obj) return true;
		HjsUsersInfo other = (HjsUsersInfo)obj;
