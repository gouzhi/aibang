...
<div class="accountContent clear">
	...
	<form action="withdraw.do?usestatus=3" method="post">
		...
		<div class="bonus">
			...
			<div style="width: 1000px; background: #fff;">
				<ul class="bonusUl clear" >
					...
					<li><a href="${project_name}/user/actbonususers/withdraw?usestatus=3" name="usestatus" val="3" class="bonusUlAct">已提现（<i>${count3 }</i>）</a></li>
				</ul>
			</div>
            <!--已使用-->
            <div class="bonsList" style="display:block;">
                <ul>
                    ...
                    <li>
                        <div class="disInline">
                        <c:choose>
                                   <c:when test="${fn:contains(pc.USE_TYPE,'1') }">
										<!-- 现金券红包-->
