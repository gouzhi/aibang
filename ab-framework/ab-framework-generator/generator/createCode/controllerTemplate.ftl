package com.cifex.controller.${packageName}.${objectNameLower};
...
import com.cifex.util.PageData;
import com.cifex.util.Tools;
import com.cifex.service.${packageName}.${objectNameLower}.${objectName}Service;
