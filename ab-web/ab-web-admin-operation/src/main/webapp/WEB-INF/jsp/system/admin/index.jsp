...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<div id="main-content" class="clearfix">
			...
			<div style="padding-left: 70%;padding-top: 1px;">
				<div style="float: left;margin-top: 3px;"><img src="${css_imagedomain}/images/loadingi.gif" /> </div>
				<div style="margin-top: -5px;"><h4 class="lighter block red">&nbsp;加载中 ...</h4></div>
			</div>
			</div>

			<div>
				<iframe name="mainFrame" id="mainFrame" frameborder="0" src="${project_name}/tab.do" style="margin:0 auto;width:100%;height:100%;"></iframe>
			</div>
	...
	<!-- basic scripts -->
		...
		<script type="text/javascript" src="${css_imagedomain}/js/myjs/menusf.js"></script>
		
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${css_imagedomain}/js/myjs/index.js"></script>
</body>
</html>
