...
public class HjsSysMenu extends BaseEntity implements Serializable{
	 ...
	 * 父类菜单
	 */
	private HjsSysMenu parentMenu;
	/**
	 * 子菜单列表
	 */
	private List<HjsSysMenu> subMenu;
	/**
	 * 是否有子菜单
	 */
	...
	public HjsSysMenu getParentMenu() {
		return parentMenu;
	}

	public void setParentMenu(HjsSysMenu parentMenu) {
		this.parentMenu = parentMenu;
	}

	public List<HjsSysMenu> getSubMenu() {
		return subMenu;
	}

	public void setSubMenu(List<HjsSysMenu> subMenu) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof HjsSysMenu == false) return false;
		if(this == obj) return true;
		HjsSysMenu other = (HjsSysMenu)obj;
