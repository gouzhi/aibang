...
public class AbUser extends BaseEntity implements Serializable{
	 ...
	 * 用户会员信息
	 */
	private AbUsersInfo hjsUsersInfo;
	/**
	 * 用户操作日志
	 */
	private List<AbUsersLog> hjsUsersLogs;
	/**
	 * 角色信息
	 */
	private List<AbSysRole> roles;
	/**
	 * 企业用户信息
	 */
	private AbUsersOpt hjsUsersOpt;
	//columns END
    /**
     * 密码级别3:高；2：中；1：低
     */
	...
	public List<AbSysRole> getRoles() {
		return roles;
	}

	public void setRoles(List<AbSysRole> roles) {
		this.roles = roles;
	}

	public AbUsersInfo getHjsUsersInfo() {
		return hjsUsersInfo;
	}

	public void setHjsUsersInfo(AbUsersInfo hjsUsersInfo) {
		this.hjsUsersInfo = hjsUsersInfo;
	}

	public List<AbUsersLog> getHjsUsersLogs() {
		return hjsUsersLogs;
	}

	public void setHjsUsersLogs(List<AbUsersLog> hjsUsersLogs) {
		this.hjsUsersLogs = hjsUsersLogs;
	}

	public AbUsersOpt getHjsUsersOpt() {
		return hjsUsersOpt;
	}

	public void setHjsUsersOpt(AbUsersOpt hjsUsersOpt) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof AbUser == false) return false;
		if(this == obj) return true;
		AbUser other = (AbUser)obj;
