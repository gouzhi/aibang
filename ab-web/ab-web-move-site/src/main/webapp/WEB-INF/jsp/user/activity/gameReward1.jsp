...
<form id="form" action="${project_name}/user/actbonususers/use?usestatus=1" method="post">   
...
<div class="rewardMenu">
	...
	<a href="${project_name}/user/actbonususers/use?usestatus=1" name="usestatus" val="1"  class="on">已使用</a>
	<a href="${project_name}/user/actbonususers/failure?usestatus=2" name="usestatus" val="2" >已过期</a>
</div>
...
<script type="text/javascript">
	...
	function unuse(){
		window.location.href="${project_name}/user/actbonususers/use1?usestatus=1";
	}
