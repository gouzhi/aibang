...
public class HjsUserQuery extends BaseQuery implements Serializable {
	 ...
	 * 用户会员信息
	 */
	private HjsUsersInfoQuery hjsUsersInfoQuery;
	/**
	 * 用户操作日志
	 */
	private List<HjsUsersLogQuery> hjsUsersLogsQuery;
	/**
	 * 角色信息
	 */
	private List<HjsSysRoleQuery> rolesQuery;
	/**
	 * 企业用户信息
	 */
	private HjsUsersOptQuery hjsUsersOptQuery;
	/**
     * 密码级别3:高；2：中；1：低
     */
	...
	public HjsUsersInfoQuery getHjsUsersInfoQuery() {
		return hjsUsersInfoQuery;
	}

	public void setHjsUsersInfoQuery(HjsUsersInfoQuery hjsUsersInfoQuery) {
		this.hjsUsersInfoQuery = hjsUsersInfoQuery;
	}

	public List<HjsUsersLogQuery> getHjsUsersLogsQuery() {
		return hjsUsersLogsQuery;
	}

	public void setHjsUsersLogsQuery(List<HjsUsersLogQuery> hjsUsersLogsQuery) {
		this.hjsUsersLogsQuery = hjsUsersLogsQuery;
	}

	public List<HjsSysRoleQuery> getRolesQuery() {
		return rolesQuery;
	}

	public void setRolesQuery(List<HjsSysRoleQuery> rolesQuery) {
		this.rolesQuery = rolesQuery;
	}

	public HjsUsersOptQuery getHjsUsersOptQuery() {
		return hjsUsersOptQuery;
	}

	public void setHjsUsersOptQuery(HjsUsersOptQuery hjsUsersOptQuery) {
