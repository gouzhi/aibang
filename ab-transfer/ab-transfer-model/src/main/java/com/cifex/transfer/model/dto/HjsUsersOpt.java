...
public class HjsUsersOpt extends BaseEntity implements Serializable{
	 ...
	 * 用户企业信息
	 */
	private HjsUsersEnterprice hjsUsersEnterprice;
	...
	public HjsUsersEnterprice getHjsUsersEnterprice() {
		return hjsUsersEnterprice;
	}

	public void setHjsUsersEnterprice(HjsUsersEnterprice hjsUsersEnterprice) {
		this.hjsUsersEnterprice = hjsUsersEnterprice;
	}
