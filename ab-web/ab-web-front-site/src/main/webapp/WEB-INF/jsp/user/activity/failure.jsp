...
<div class="accountContent clear">
   <div id="nav_point" class="icoPoint">
	...
	<form action="failure.do?usestatus=2" method="post">
		...
		<div class="bonus">
            ...
            <div style="width: 1000px; background: #fff;">
                <ul class="bonusUl clear" >
                    ...
                    <li><a href="${project_name}/user/actbonususers/failure?usestatus=2" name="usestatus" class="bonusUlAct" val="2">已过期（<i>${count2 }</i>）</a></li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="disInline">
                                ...
                                <%--<div class="text_J_end"><i>￥</i>${pc.VALUE }</div>--%>
                                <%--</div>--%>
                        ...
                        <div class="zt" style="text-align: center;margin: 20px auto 0;">
                            <span>
