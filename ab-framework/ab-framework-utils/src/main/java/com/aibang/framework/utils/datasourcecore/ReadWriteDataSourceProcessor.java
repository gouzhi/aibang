package com.aibang.framework.utils.datasourcecore;
 ...
 *       @ cn.javass.common.datasource.ReadWriteDataSourceDecision
 *       @ cn.javass.common.datasource.ReadWriteDataSource
 * 
 * </pre>
 * @author Zhang Kaitao
 *
...
public class ReadWriteDataSourceProcessor implements BeanPostProcessor {
    ...
    private class ReadWriteDataSourceTransactionException extends NestedRuntimeException {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 6320613667905125154L;
