 ...
 * @date 2015年8月17日     
 */
package com.cifex.framework.utils.hex;
...
public class HexUtil {
    ...
    /**
     * @methodname hexStringToByte  
     * @discription 将16进制字符串转换成数组 
     * @param hex
     * @return byte[]
     * @author zeng.fangfang
     * @date 2015年8月17日
    ...
    /**
     * @methodname validPasswd  
     * @discription 密码验证 
     * @param passwd 用户输入密码
     * @param dbPasswd 数据库保存的密码
     * @return boolean <b>true一致</b>，<b>false</b> 不一致
    ...
    /**
     * @methodname getEncryptedPwd  
     * @discription 获得md5之后的16进制字符 
     * @param passwd 用户输入密码字符
     * @return String md5加密后密码字符 ,返回一个长度为56的字符串
     * @throws java.security.NoSuchAlgorithmException
     * @throws java.io.UnsupportedEncodingException
     * @author zeng.fangfang
     * @date 2015年8月17日
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
    	...
    	String password = getEncryptedPwd(pwdString);
    	System.out.println(password);
    	boolean b = validPasswd(pwdString, password);
