...
public class AbApproveRealname extends BaseEntity implements Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof AbApproveRealname == false) return false;
		if(this == obj) return true;
		AbApproveRealname other = (AbApproveRealname)obj;
