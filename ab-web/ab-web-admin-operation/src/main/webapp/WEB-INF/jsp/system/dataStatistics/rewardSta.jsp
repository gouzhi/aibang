...
<body>
				...
				<div class="row-fluid">
					...
					<form  method="post"
						...
						<table id="table_report"
							...
							<tbody>
							<c:choose>
								<c:when test="${not empty ActBonusUsersList}">

									<c:forEach items="${ActBonusUsersList}" var="bp"
											   varStatus="vs">
										...
										<tr>
											...
											<td class="center">${bp.VALUE_SUM}</td>
	...
	<script type="text/javascript">
        //检索
		function search() {
			$("#projectForm").attr("action","${project_name}/rewardSta/getRewardSta.do");
         $("#projectForm").submit();

		}
		function exportExcel(){
			$("#projectForm").attr("action","${project_name}/rewardSta/exportExcel.do");
			$("#projectForm").submit();
		}
     </script>
